export const fp22Data = {
  ...
  explanation: "Build an enterprise portal tracking employee directory records, department structures, leave requests, and payroll updates.",
  progression: [
    {
  ...
  detailedReference: {
    summary: "Build a highly scalable MERN stack implementation of a Human Resource Management (HRM) System showing production-ready practices.",
    keyConcepts: [
  ...
  codeTemplate: {
    html: `<!-- FP-22 Capstone Client Index -->\n<div id="fp-22-root">\n  <h2>Human Resource Management (HRM) System Workspace</h2>\n  <p>Submission Panel</p>\n</div>`,
    css: `/* FP-22 layout constraints */\n#fp-22-root {\n  padding: 2rem;\n  background: #fafafa;\n  border-radius: 8px;\n}`,
    js: `// FP-22 Handshake initialization\nconst AppInitializer = {\n  name: "Human Resource Management (HRM) System",\n  code: "FP-22",\n  status: "Draft",\n  init() {\n    console.log(this.name + " running...");\n  }\n};`
  },

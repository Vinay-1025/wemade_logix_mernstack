export const fp12Data = {
  projectCode: "FP-12",
  title: "Job Search & Career Recruitment Portal",
  explanation: "Build an employer-candidate matching portal featuring resume builders, application trackers, job filtering, and direct chats.",
  progression: [
    {
  ...
  detailedReference: {
    summary: "Build a highly scalable MERN stack implementation of a Job Search & Career Recruitment Portal showing production-ready practices.",
    keyConcepts: [
  ...
  codeTemplate: {
    html: `<!-- FP-12 Capstone Client Index -->\n<div id="fp-12-root">\n  <h2>Job Search & Career Recruitment Portal Workspace</h2>\n  <p>Submission Panel</p>\n</div>`,
    css: `/* FP-12 layout constraints */\n#fp-12-root {\n  padding: 2rem;\n  background: #fafafa;\n  border-radius: 8px;\n}`,
    js: `// FP-12 Handshake initialization\nconst AppInitializer = {\n  name: "Job Search & Career Recruitment Portal",\n  code: "FP-12",\n  status: "Draft",\n  init() {\n    console.log(this.name + " running...");\n  }\n};`
  },

export const fp30Data = {
  projectCode: "FP-30",
  title: "Gym Membership & Schedule Booking System",
  explanation: "Build a club manager app scheduling class times, tracking member attendance, billing status, and training calendars.",
  progression: [
    {
  ...
  detailedReference: {
    summary: "Build a highly scalable MERN stack implementation of a Gym Membership & Schedule Booking System showing production-ready practices.",
    keyConcepts: [
  ...
  codeTemplate: {
    html: `<!-- FP-30 Capstone Client Index -->\n<div id="fp-30-root">\n  <h2>Gym Membership & Schedule Booking System Workspace</h2>\n  <p>Submission Panel</p>\n</div>`,
    css: `/* FP-30 layout constraints */\n#fp-30-root {\n  padding: 2rem;\n  background: #fafafa;\n  border-radius: 8px;\n}`,
    js: `// FP-30 Handshake initialization\nconst AppInitializer = {\n  name: "Gym Membership & Schedule Booking System",\n  code: "FP-30",\n  status: "Draft",\n  init() {\n    console.log(this.name + " running...");\n  }\n};`
  },

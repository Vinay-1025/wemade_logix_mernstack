export const fp03Data = {
  projectCode: "FP-03",
  title: "Real-Time Collaborative Project Board",
  explanation: "Build a Trello clone with live WebSocket board updates, drag-and-drop cards, and role-based board permissions.",
  progression: [
    {
  ...
  detailedReference: {
    summary: "Build a highly scalable MERN stack implementation of a Real-Time Collaborative Project Board showing production-ready practices.",
    keyConcepts: [
  ...
  codeTemplate: {
    html: `<!-- FP-03 Capstone Client Index -->\n<div id="fp-03-root">\n  <h2>Real-Time Collaborative Project Board Workspace</h2>\n  <p>Submission Panel</p>\n</div>`,
    css: `/* FP-03 layout constraints */\n#fp-03-root {\n  padding: 2rem;\n  background: #fafafa;\n  border-radius: 8px;\n}`,
    js: `// FP-03 Handshake initialization\nconst AppInitializer = {\n  name: "Real-Time Collaborative Project Board",\n  code: "FP-03",\n  status: "Draft",\n  init() {\n    console.log(this.name + " running...");\n  }\n};`
  },

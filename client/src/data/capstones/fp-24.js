export const fp24Data = {
  projectCode: "FP-24",
  title: "Food Delivery & Restaurant Directory App",
  explanation: "Build an ordering app featuring restaurant menu categories, shopping cart states, order tracker status, and review forms.",
  progression: [
    {
  ...
  detailedReference: {
    summary: "Build a highly scalable MERN stack implementation of a Food Delivery & Restaurant Directory App showing production-ready practices.",
    keyConcepts: [
  ...
  codeTemplate: {
    html: `<!-- FP-24 Capstone Client Index -->\n<div id="fp-24-root">\n  <h2>Food Delivery & Restaurant Directory App Workspace</h2>\n  <p>Submission Panel</p>\n</div>`,
    css: `/* FP-24 layout constraints */\n#fp-24-root {\n  padding: 2rem;\n  background: #fafafa;\n  border-radius: 8px;\n}`,
    js: `// FP-24 Handshake initialization\nconst AppInitializer = {\n  name: "Food Delivery & Restaurant Directory App",\n  code: "FP-24",\n  status: "Draft",\n  init() {\n    console.log(this.name + " running...");\n  }\n};`
  },

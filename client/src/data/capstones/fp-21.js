export const fp21Data = {
  projectCode: "FP-21",
  title: "Cloud File Storage & Encrypted Sharing Portal",
  explanation: "Build a files directory supporting folder hierarchies, document previewers, access controls, and sharing link tokens.",
  progression: [
    {
  ...
  detailedReference: {
    summary: "Build a highly scalable MERN stack implementation of a Cloud File Storage & Encrypted Sharing Portal showing production-ready practices.",
    keyConcepts: [
  ...
  codeTemplate: {
    html: `<!-- FP-21 Capstone Client Index -->\n<div id="fp-21-root">\n  <h2>Cloud File Storage & Encrypted Sharing Portal Workspace</h2>\n  <p>Submission Panel</p>\n</div>`,
    css: `/* FP-21 layout constraints */\n#fp-21-root {\n  padding: 2rem;\n  background: #fafafa;\n  border-radius: 8px;\n}`,
    js: `// FP-21 Handshake initialization\nconst AppInitializer = {\n  name: "Cloud File Storage & Encrypted Sharing Portal",\n  code: "FP-21",\n  status: "Draft",\n  init() {\n    console.log(this.name + " running...");\n  }\n};`
  },

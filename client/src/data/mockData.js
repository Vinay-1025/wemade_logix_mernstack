    ...
    days: [
      {
        ...
        topics: [
            ...
            quiz: [
              {
                ...
                options: ["Speed", "Secure", "Server", "Script"],
                correctAnswer: 1
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which part of <h1>Hello</h1> is the 'content'?",
                options: ["<h1>", "Hello", "</h1>", "The whole line"],
                correctAnswer: 1
              }
            ],
            ...
            quiz: [
              {
                ...
                options: ["Inside <body>", "Inside <head>", "Outside <html>", "Anywhere"],
                correctAnswer: 1
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which heading is the 'least' important visually?",
        ...
        topics: [
          {
            ...
            quiz: [
              {
                question: "Which tag is used to create a container for user input?",
                options: ["<input>", "<form>", "<label>", "<button>"],
                correctAnswer: 1
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which input type allows only one selection from a group?",
                options: ["checkbox", "radio", "text", "email"],
                correctAnswer: 1
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which method is safer for sending passwords?",
                options: ["GET", "POST", "SEND", "HIDE"],
                correctAnswer: 1
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which tag represents a single row in a table?",
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which tag is best for your site's navigation links?",
                options: ["<div>", "<links>", "<nav>", "<section>"],
                correctAnswer: 2
              }
            ],
            ...
            quiz: [
              {
                ...
                options: ["Alt color", "Alternative text for images", "Alternative links", "Alt behavior"],
                correctAnswer: 1
              }
            ],
      ...
      },
      {
        ...
        topics: [
            ...
            quiz: [
              {
                ...
                options: ["Color", "Cascading", "Content", "Center"],
                correctAnswer: 1
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which selector is used to target unique elements?",
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which unit scales based on the root font size?",
                options: ["px", "%", "rem", "vh"],
                correctAnswer: 2
              }
            ],
            ...
            quiz: [
              {
                ...
                options: ["font-style", "font-weight", "font-family", "text-size"],
                correctAnswer: 1
              }
            ],
            ...
            quiz: [
              {
                ...
                options: ["corner-style", "border-radius", "round-border", "box-edge"],
                correctAnswer: 1
              }
            ],
        ...
        topics: [
          {
            ...
            quiz: [
              {
                question: "Which display property makes an element take up the full width available?",
            ...
            quiz: [
              {
                ...
                options: ["display: block", "layout: flex", "display: flex", "flex: on"],
                correctAnswer: 2
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which property is used for vertical alignment in a row layout?",
                options: ["justify-content", "align-items", "flex-direction", "center"],
                correctAnswer: 1
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which property allows an item to take up all remaining space?",
                options: ["flex-basis", "flex-grow", "align-self", "flex-shrink"],
                correctAnswer: 1
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "What is the modern way to add space between flex items?",
                options: ["margin", "padding", "gap", "spacer"],
                correctAnswer: 2
              }
            ],
      ...
      },
      {
        ...
        topics: [
            ...
            quiz: [
              {
                ...
                options: ["Only building for mobile", "Designing for mobile first, then scaling up", "Designing for desktop first", "Building a separate site for mobile"],
                correctAnswer: 1
              }
            ],
            ...
            quiz: [
              {
                ...
                options: ["@screen", "@responsive", "@media", "@width"],
                correctAnswer: 2
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "What does 'max-width: 500px' do?",
                options: ["Forces the element to be 500px wide", "Prevents the element from growing larger than 500px", "Makes the element exactly 500px on mobile", "Stretches the element to 500px"],
                correctAnswer: 1
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which property crops an image to fit its container without stretching?",
                options: ["image-size", "aspect-ratio", "object-fit", "img-crop"],
                correctAnswer: 2
              }
            ],
      ...
      },
      {
        ...
        topics: [
            ...
            quiz: [
              {
                ...
                options: ["Writing code", "Tracking changes in source code", "Hosting websites", "Designing UI"],
                correctAnswer: 1
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which command moves files from the working directory to the staging area?",
                options: ["git commit", "git init", "git add", "git save"],
                correctAnswer: 2
              }
            ],
            ...
            quiz: [
              {
                ...
                options: ["git push", "git download", "git clone", "git copy"],
                correctAnswer: 2
              }
            ],
            ...
            quiz: [
              {
                ...
                options: ["To delete code", "To work on features in isolation", "To host a website", "To rename files"],
                correctAnswer: 1
              }
            ],
      ...
      },
      {
        ...
        topics: [
          ...
          },
          {
            ...
            quiz: [
              {
                question: "What is the main goal of wireframing?",
                options: ["Picking colors", "Planning the layout structure", "Writing JavaScript", "Testing speed"],
                correctAnswer: 1
              }
            ],
        ...
        topics: [
          {
            ...
            quiz: [
              {
                question: "Which of these is JavaScript responsible for?",
                options: ["Page structure", "Page styling", "Page interactivity", "Page database"],
                correctAnswer: 2
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which keyword should you use for a value that should never change?",
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which keyword is used to handle the default case in a switch statement?",
                options: ["else", "fallback", "default", "other"],
                correctAnswer: 2
              }
            ],
            ...
            quiz: [
              {
                ...
                options: ["for", "while", "do-while", "each"],
                correctAnswer: 2
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "What is the return type of prompt()?",
        ...
        topics: [
          {
            ...
            quiz: [
              {
                question: "What value is returned by a function that has no return statement?",
            ...
            quiz: [
              {
                ...
                options: ["function() => {}", "const x = () => {}", "x = () -> {}", "() => function {}"],
                correctAnswer: 1
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which keyword does NOT have block scope?",
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which method creates a new array by removing unwanted items?",
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which character is used to separate keys and values in an object?",
                options: ["=", ":", "->", "=>"],
                correctAnswer: 1
              }
            ],
      ...
      },
      {
        ...
        topics: [
            ...
            quiz: [
              {
                ...
                options: ["Data Object Management", "Document Object Model", "Digital Order Method", "Document Or Model"],
                correctAnswer: 1
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which selector should you use to find ALL elements with a specific class?",
                options: ["getElementById", "querySelector", "querySelectorAll", "findClass"],
                correctAnswer: 2
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which property is used to change the HTML content inside an element?",
                options: ["innerText", "textContent", "innerHTML", "value"],
                correctAnswer: 2
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which method is preferred for adding event listeners?",
                options: ["onclick", "addEventListener", "onEvent", "attachEvent"],
                correctAnswer: 1
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which function stops a form from refreshing the page?",
                options: ["e.stop()", "e.preventDefault()", "e.halt()", "form.cancel()"],
                correctAnswer: 1
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which method adds a new node inside a parent node?",
                options: ["addNode", "appendChild", "insertInner", "pushElement"],
                correctAnswer: 1
              }
            ],
        ...
        topics: [
          {
            ...
            quiz: [
              {
                question: "What structure does the JS Call Stack follow?",
                options: ["FIFO (First In First Out)", "LIFO (Last In First Out)", "Random", "Circular"],
                correctAnswer: 1
              }
            ],
            ...
            quiz: [
              {
                ...
                options: ["A way to close a browser tab", "A function that remembers its outer variables", "A type of loop", "An error handling method"],
                correctAnswer: 1
              }
            ],
            ...
            quiz: [
              {
                ...
                options: ["A function with many lines", "A function that takes or returns another function", "A function at the top of the file", "A mathematical function"],
                correctAnswer: 1
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which function is used to run code after a specific delay?",
                options: ["runAfter", "wait", "setTimeout", "delay"],
                correctAnswer: 2
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which method is used to handle a successfully fulfilled promise?",
            ...
            quiz: [
              {
                ...
                options: ["Anywhere", "Only in async functions", "Inside loops", "Inside if statements"],
                correctAnswer: 1
              }
            ],
        ...
        topics: [
          {
            ...
            quiz: [
              {
                question: "In which year was the major ES6 update released?",
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which brackets are used for object destructuring?",
                options: ["[]", "{}", "()", "<>"],
                correctAnswer: 1
              }
            ],
            ...
            quiz: [
              {
                ...
                options: ["Deletes it", "Expands it into individual elements", "Reverses it", "Sorts it"],
                correctAnswer: 1
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which keyword is used to share a function from one file to another?",
                options: ["share", "give", "export", "send"],
                correctAnswer: 2
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which storage stays even after the browser is closed?",
                options: ["Session Storage", "Local Storage", "Cookie Storage", "RAM Storage"],
                correctAnswer: 1
              }
            ],
        ...
        topics: [
          {
            ...
            quiz: [
              {
                question: "Which block runs regardless of an error occurring?",
                options: ["try", "catch", "finally", "then"],
                correctAnswer: 2
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which browser tool tab is used for setting breakpoints?",
                options: ["Console", "Network", "Sources", "Application"],
                correctAnswer: 2
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which method returns a single value after processing the entire array?",
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which property of a fetch response tells you if it was successful (status 200-299)?",
                options: ["status", "success", "ok", "valid"],
                correctAnswer: 2
              }
            ],
        ...
        topics: [
          {
            ...
            quiz: [
              {
                question: "Which of these is NOT a core JS pillar covered this week?",
                options: ["DOM Manipulation", "Asynchronous JS", "Database Indexing", "Array Methods"],
                correctAnswer: 2
              }
            ],
            ...
            quiz: [
              {
                ...
                options: ["Writing the code", "Copy-pasting from StackOverflow", "Understanding the problem requirements", "Optimizing performance"],
                correctAnswer: 2
              }
            ],
            ...
            quiz: [
              {
                ...
                options: ["Do Repeat Yourself", "Don't Repeat Yourself", "Data Realtime Yield", "Digital Rule Yard"],
                correctAnswer: 1
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Which concept involves adding a listener to a parent element to manage children?",
                options: ["Event Bubbling", "Event Delegation", "Event Capture", "Event Prevention"],
                correctAnswer: 1
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "Why should you transform API data before rendering?",
                options: ["To make it slower", "To match your UI requirements", "To hide information from the user", "It's a mandatory requirement"],
                correctAnswer: 1
              }
            ],
          ...
          },
          {
            ...
            quiz: [
              {
                question: "What is the main benefit of 'Separation of Concerns'?",
                options: ["Makes code run faster", "Makes code easier to maintain and test", "Increases file size", "Hides code from other developers"],
                correctAnswer: 1
              }
            ],

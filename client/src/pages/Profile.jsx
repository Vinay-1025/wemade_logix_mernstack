    ...
    img.onload = () => {
      ...
      if (svgEl) {
        ...
        qrImg.onload = () => {
          ...
          ctx.fillText("45 Days", canvas.width * 0.298, canvas.height * 0.690);
          ...
          ctx.fillText(certificateId, canvas.width * 0.588, canvas.height * 0.690);
          ...
          ctx.fillText(issueDateStr, canvas.width * 0.588, canvas.height * 0.752);

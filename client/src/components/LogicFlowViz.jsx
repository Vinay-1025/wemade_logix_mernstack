  ...
  return (
    <div className="logic-viz">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        .logic-viz { padding: 20px; color: white; display: flex; flex-direction: column; align-items: center; min-height: 450px; }
        ...
        .flow-node { padding: 12px 24px; background: rgba(255,255,255,0.05); border: 1px solid var(--app-border); border-radius: 8px; font-family: monospace; z-index: 1; }
        .flow-node.start { border-radius: 50px; background: #64748b; font-size: 0.8rem; }
        .flow-node.condition { background: #0f172a; border-color: var(--primary-cyan); }
        ...
        .flow-node.result.success { background: #166534; border-color: #4ade80; }
        .flow-node.result.error { background: #991b1b; border-color: #f87171; }

        /* switch machine */
        .switch-machine { background: #0f172a; padding: 20px; border-radius: 20px; border: 1px solid rgba(255,255,255,0.1); width: 100%; max-width: 400px; position: relative; }
        .machine-header { font-size: 0.7rem; text-transform: uppercase; color: var(--primary-cyan); text-align: center; margin-bottom: 20px; }
        .input-tunnel { height: 100px; position: relative; border-left: 4px solid #334155; border-right: 4px solid #334155; margin: 0 auto; width: 40px; }
        .value-ball { 
        ...
        .bucket { flex: 1; height: 80px; border: 2px solid #334155; border-top: none; border-radius: 0 0 15px 15px; position: relative; transition: all 0.3s; padding: 10px; text-align: center; }
        .bucket.active { border-color: #4ade80; background: rgba(74, 222, 128, 0.1); transform: translateY(5px); }
        .bucket-label { font-size: 0.6rem; color: #94a3b8; margin-bottom: 5px; }
        .bucket-body { font-size: 0.75rem; font-weight: bold; }

        /* ternary gate */
        .ternary-machine { text-align: center; background: #0f172a; padding: 30px; border-radius: 20px; border: 1px solid rgba(255,255,255,0.1); width: 100%; max-width: 400px; }
        ...
        .gate-pivot { width: 4px; height: 50px; background: #f472b6; position: relative; transform-origin: top center; border-radius: 2px; box-shadow: 0 0 10px rgba(244, 114, 182, 0.5); }
        .gate-pivot::after {
          content: '';
          position: absolute;
          bottom: -5px;
        ...
        .t-output-box { padding: 10px 20px; border: 1px solid #334155; border-radius: 10px; color: #475569; transition: all 0.3s; font-weight: bold; }
        .t-output-box.active { border-color: #4ade80; color: #4ade80; background: rgba(74, 222, 128, 0.1); transform: scale(1.1); }
